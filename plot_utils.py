...
def plot_state(lcs, plotName, agent, number_of_transients=None, title=None, xlim=[0,7], interact=False, plots_window_size=10):
    ...
    lcs.sort_values(by=['position'], inplace=True)
